...
ORC_EXPORT const char * orc_x86_get_regname_mmx(int i);
ORC_EXPORT void orc_x86_emit_mov_memoffset_mmx (OrcCompiler *compiler, int size,
    int offset, int reg1, int reg2, int is_aligned);
ORC_EXPORT void orc_x86_emit_mov_memindex_mmx (OrcCompiler *compiler, int size,
    int offset, int reg1, int regindex, int shift, int reg2, int is_aligned);
ORC_EXPORT void orc_x86_emit_mov_mmx_memoffset (OrcCompiler *compiler, int size,
...
#endif
ORC_EXPORT unsigned int orc_mmx_get_cpu_flags (void);

ORC_EXPORT void orc_mmx_load_constant (OrcCompiler *compiler, int reg, int size,
    orc_uint64 value);
