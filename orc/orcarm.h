...
ORC_EXPORT unsigned long orc_arm_get_cpu_flags (void);

ORC_EXPORT void orc_arm_emit (OrcCompiler *compiler, orc_uint32 insn);
ORC_EXPORT void orc_arm_emit_bx_lr (OrcCompiler *compiler);
ORC_EXPORT const char * orc_arm_reg_name (int reg);
ORC_EXPORT const char * orc_arm_cond_name (OrcArmCond cond);
ORC_EXPORT void orc_arm_emit_load_imm (OrcCompiler *compiler, int dest, int imm);

ORC_EXPORT void orc_arm_emit_add (OrcCompiler *compiler, int dest, int src1, int src2);
ORC_EXPORT void orc_arm_emit_sub (OrcCompiler *compiler, int dest, int src1, int src2);
ORC_EXPORT void orc_arm_emit_add_imm (OrcCompiler *compiler, int dest, int src1, int value);
ORC_EXPORT void orc_arm_emit_and_imm (OrcCompiler *compiler, int dest, int src1, int value);
ORC_EXPORT void orc_arm_emit_sub_imm (OrcCompiler *compiler, int dest, int src1, int value, int record);
ORC_EXPORT void orc_arm_emit_asr_imm (OrcCompiler *compiler, int dest, int src1, int value);
ORC_EXPORT void orc_arm_emit_lsl_imm (OrcCompiler *compiler, int dest, int src1, int value);
ORC_EXPORT void orc_arm_emit_cmp_imm (OrcCompiler *compiler, int src1, int value);
ORC_EXPORT void orc_arm_emit_cmp (OrcCompiler *compiler, int src1, int src2);
ORC_EXPORT void orc_arm_emit_mov (OrcCompiler *compiler, int dest, int src);

ORC_EXPORT void orc_arm_emit_align (OrcCompiler *compiler, int align_shift);
ORC_EXPORT void orc_arm_emit_label (OrcCompiler *compiler, int label);
ORC_EXPORT void orc_arm_emit_push (OrcCompiler *compiler, int regs, orc_uint32 vregs);
ORC_EXPORT void orc_arm_emit_pop (OrcCompiler *compiler, int regs, orc_uint32 vregs);
ORC_EXPORT void orc_arm_emit_branch (OrcCompiler *compiler, int cond, int label);
ORC_EXPORT void orc_arm_emit_data (OrcCompiler *compiler, orc_uint32 data);

ORC_EXPORT void orc_arm_loadb (OrcCompiler *compiler, int dest, int src1, int offset);
ORC_EXPORT void orc_arm_storeb (OrcCompiler *compiler, int dest, int offset, int src1);
ORC_EXPORT void orc_arm_loadw (OrcCompiler *compiler, int dest, int src1, int offset);
ORC_EXPORT void orc_arm_storew (OrcCompiler *compiler, int dest, int offset, int src1);
ORC_EXPORT void orc_arm_loadl (OrcCompiler *compiler, int dest, int src1, int offset);
ORC_EXPORT void orc_arm_storel (OrcCompiler *compiler, int dest, int offset, int src1);

ORC_EXPORT void orc_arm_emit_load_reg (OrcCompiler *compiler, int dest, int src1, int offset);
ORC_EXPORT void orc_arm_emit_store_reg (OrcCompiler *compiler, int src, int dest, int offset);

ORC_EXPORT void orc_arm_add_fixup (OrcCompiler *compiler, int label, int type);
ORC_EXPORT void orc_arm_do_fixups (OrcCompiler *compiler);

ORC_EXPORT void orc_arm_emit_dp (OrcCompiler *p, int type, OrcArmCond cond, OrcArmDP opcode,
    int S, int Rd, int Rn, int Rm, int shift, orc_uint32 val);
ORC_EXPORT void orc_arm_emit_par (OrcCompiler *p, int op, int mode, OrcArmCond cond, int Rd, int Rn, int Rm);
ORC_EXPORT void orc_arm_emit_xt (OrcCompiler *p, int op, OrcArmCond cond, int Rd, int Rn, int Rm, int r8);
ORC_EXPORT void orc_arm_emit_pkh (OrcCompiler *p, int op, OrcArmCond cond, int Rd, int Rn, int Rm, int sh);
ORC_EXPORT void orc_arm_emit_sat (OrcCompiler *p, int op, OrcArmCond cond, int Rd, int sat, int Rm, int sh, int asr);
ORC_EXPORT void orc_arm_emit_rv (OrcCompiler *p, int op, OrcArmCond cond, int Rd, int Rm);
ORC_EXPORT void orc_arm_emit_nop (OrcCompiler *compiler);

ORC_EXPORT void orc_arm_flush_cache (OrcCode *code);
